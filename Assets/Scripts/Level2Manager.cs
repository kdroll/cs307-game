...
public class Level2Manager : MonoBehaviour {
	...
	void Start()
	{
		...
		enemy = GameObject.FindGameObjectWithTag("PenguinEnemy");
	...
	void Update()
	{
		...
		amount = GameObject.FindGameObjectsWithTag("PenguinEnemy");
		...
		if (updateCountSpawnNum % spawnRate == 0)
		{
			...
			if (players.Length > 0)
			{
				...
				if (choice == 1)
				{
					...
					GameObject enemyClone = GameObject.FindGameObjectWithTag("PenguinEnemy");
