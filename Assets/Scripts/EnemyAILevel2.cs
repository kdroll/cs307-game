...
public class EnemyAILevel2 : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        {
            gold = EnemyAi.gold;
            totalScore = EnemyAi.totalScore;
            firstEnemy = false;
        }
        enemyTransform = this.GetComponent<Transform>();
        anim = this.GetComponent<Animator>();
        enemyHealth = ((6 - Level2Manager.difficulty) * 10) + (Level2Manager.changeEnemyHealth) * 1;
    ...
    IEnumerator wait()
    {
        ...
        int rand = rnd.Next(1, (200 - ((Level2Manager.difficulty - 1) * 20) - (20 * PlayerHealth.perks[1])));
                ...
                if (hit.collider != null)
                {
                    ...
                    if (hit.collider.gameObject.CompareTag("Obstacle"))
                    {
                        ...
                        { // above
                            ...
                            int right = 0;
                            int i;
                            for (i = (int)hitx; Level2Manager.walls[i, (int)hity] != 0; i++)
                            {
                                right++;
                            }
                            ...
                            //print("wall = " + Level2Manager.walls[(int)transform.position.x + 1, (int)hity + 1]);
                            if (Level2Manager.walls[(int)transform.position.x + 1, (int)hity + 1] == 1)
                            {
                                right = 100;
                            }
                            for (i = (int)hitx; Level2Manager.walls[i, (int)hity] != 0; i--)
                        ...
                        { //right
                            ...
                            int right = 0;
                            int i;
                            for (i = (int)hity; Level2Manager.walls[(int)hitx, i] != 0; i++)
                            {
                                right++;
                            }
                            //print("enemy pos = " + transform.position.x + "," + transform.position.y + "  wall at that pos and up one = " + ((int)(transform.position.x + 1)) + "," + ((int)(hity + 1)));
                            //print("wall = " + Level2Manager.walls[(int)transform.position.x + 1, (int)hity + 1]);
                            if (Level2Manager.walls[(int)hitx + 1, (int)transform.position.y + 1] == 1)
                            {
                                right = 100;
                            }
                            for (i = (int)hity; Level2Manager.walls[(int)hitx, i] != 0; i--)
