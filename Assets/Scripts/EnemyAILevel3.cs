...
public class EnemyAILevel3 : MonoBehaviour
{
    ...
    IEnumerator wait()
    {
        ...
        int rand = rnd.Next(1, (200 - ((Level3Manager.difficulty - 1) * 20) - (20 * PlayerHealth.perks[1])));
                ...
                if (hit.collider != null)
                {
                    ...
                    if (hit.collider.gameObject.CompareTag("Obstacle"))
                    {
                        ...
                        { // above
                            ...
                            int right = 0;
                            int i;
                            for (i = (int)hitx; Level3Manager.walls[i, (int)hity] != 0; i++)
                            {
                                right++;
                            }
                            ...
                            //print("wall = " + Level3Manager.walls[(int)transform.position.x + 1, (int)hity + 1]);
                            if (Level3Manager.walls[(int)transform.position.x + 1, (int)hity + 1] == 1)
                            {
                                right = 100;
                            }
                            for (i = (int)hitx; Level3Manager.walls[i, (int)hity] != 0; i--)
                        ...
                        { //right
                            ...
                            int right = 0;
                            int i;
                            for (i = (int)hity; Level3Manager.walls[(int)hitx, i] != 0; i++)
                            {
                                right++;
                            }
                            //print("enemy pos = " + transform.position.x + "," + transform.position.y + "  wall at that pos and up one = " + ((int)(transform.position.x + 1)) + "," + ((int)(hity + 1)));
                            //print("wall = " + Level3Manager.walls[(int)transform.position.x + 1, (int)hity + 1]);
                            if (Level3Manager.walls[(int)hitx + 1, (int)transform.position.y + 1] == 1)
                            {
                                right = 100;
                            }
                            for (i = (int)hity; Level3Manager.walls[(int)hitx, i] != 0; i--)
